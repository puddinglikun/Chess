...
public class RayCastHitControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        heroName = showText.transform.Find("HeroName").GetComponent<Text>();
        hpText = showText.transform.Find("HP").GetComponent<Text>();
        atkText = showText.transform.Find("ATK").GetComponent<Text>();
        skillText = showText.transform.Find("Skill").GetComponent<Text>();
